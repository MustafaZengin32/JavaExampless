...
/*
     ...
     */
        ...
        Integer cuneytAge = studentAges.get("Ayhan Isik");
        System.out.println("Ayhan Isık : " + cuneytAge);// null
        ...
        System.out.println(studentAges);//{null=66, Ayhan Isik=null, Sadri Alisik=null, Tom=21, Brad=12, Cuneyt=75, Ali=88}
