...
public class Polymorphism02GeciciIsci extends Polymorphism02Isci {
    ...
    public static void main(String[] args) {
        ...
        Polymorphism02GeciciIsci gi1=new Polymorphism02GeciciIsci ();
    ...
    @Override  // annotation
    public void mesai() {
        //super.mesai();//isciler gunluk 8 saat calisir
