...
public class Iterators02 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // Ne zaman Iterater kullanılmalıdır  (ListIterator a gerek yoktur
        //  i )eger iki taraflı hareket etmek işstemiyorsaniz
        //  i ) list elemanlarının degistirilmesini istemiyorsanız
        //  i )sadece liste elelmanlarının silinmesini istiyorsanız

        // Listleri update etmek isterseniz ListIterator kullanırız Cunku Iterator ların update ozelligi yoktur

        //ListIterator cok özelligi var ama bu tehlikelidir list inizi bozulmasına neden olur
    }
}
