...
public class Inheritance03AvciKuslar extends Inheritance03Kuslar{
    ...
    public static void main(String[] args) {
        ...
        Inheritance03AvciKuslar avci1= new  Inheritance03AvciKuslar();
        /*
        ...
        Inheritance03Kuslar avci2= new  Inheritance03Kuslar();
        /*
          Bir obje olusturulurken
        ...
        Inheritance03Hayvanlar avci3= new Inheritance03AvciKuslar();
        ...
        Inheritance03Kuslar kus1= new  Inheritance03Kuslar();
        kus1.cogalma();// Kuslar
        kus1.gaga(); // Kuslar
        kus1.kanat(); // Kuslar
        ...
        Inheritance03Hayvanlar kus2= new  Inheritance03Kuslar();
        kus2.cogalma();// Kuslar
        //kus2.gaga(); // CTE
        //kus2.kanat(); // CTE
        ...
        //burada sol taraf referans alinan en ust nokta veri burda varsa sag taraftaki tabana kadar gider geriye arar
        //ancak sol taraftaki en ust noktada method yoksa sag tarafa kadar hic aramaz
        //variable da ilk gordugunu alir
        //methodda en gunceli alir
    }
}
