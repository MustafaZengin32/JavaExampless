...
public class Inheritance01Personel {

    public String isim;
    public int sayi;

    public Inheritance01Personel() { // parametresiz bir cons. olusturdum
        // super();
		/*
    ...
    public Inheritance01Personel(String isim, int sayi) { // parametreli bir cons. olusturdum
        //super();
